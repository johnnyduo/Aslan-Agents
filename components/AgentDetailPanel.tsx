      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 bg-black p-2 rounded border border-white/10 font-mono text-xs text-gray-400 break-all">
                    {agent.walletAddress}
                    <Copy size={12} className="ml-auto cursor-pointer hover:text-white" />
                </div>
            </div>

            <div className="space-y-2 pt-4 border-t border-white/10">
                <label className="text-xs text-gray-500 font-mono uppercase flex items-center gap-2">
                    <Terminal size={12} /> HF Generation Prompt
                </label>
                <div className="bg-black p-3 rounded border border-white/10 text-[10px] text-gray-500 font-mono leading-relaxed max-h-32 overflow-y-auto select-text">
                    {agent.hfPrompt}
                </div>
            </div>
        </div>
